...
import es.uca.iw.onlinejob.web.UsersController;
...
privileged aspect UsersController_Roo_Controller {
    ...
    public String UsersController.createForm(Model uiModel) {
        ...
        if (Roles.countRoleses() == 0) {
            dependencies.add(new String[] { "sexo", "roleses" });
        }
    ...
    void UsersController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("users_fecha_registro_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
