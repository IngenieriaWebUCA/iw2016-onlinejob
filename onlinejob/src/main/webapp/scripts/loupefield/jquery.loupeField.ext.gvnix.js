			...
			if (onSetNameFunction !== "") {
				callbackFunctions[onSetNameFunction] = function(functionName,
					...
					if (typeof window[onSetNameFunction] == "function") {
						...
						console.log("[ERROR] : " + onSetNameFunction
								+ " is not defined at 'loupe-callbacks.js'");
					}
				}
				instance._fnSetItemCallback
			...
			if (onDrawNameFunction !== "") {
				...
				callbackFunctions[onDrawNameFunction] = function(functionName,
					...
					if (typeof window[onDrawNameFunction] == "function") {
						...
						console.log("[ERROR] : " + onDrawNameFunction
								+ " is not defined at 'loupe-callbacks.js'");
					}
				}
		...
		if (form !== null) {
			...
			if (relatedField !== null && relatedField.data() !== null) {
				...
				if (currentFieldId.search("_create") !== -1) {
					relatedFieldId += currentFieldId.substr(currentFieldId
							.search("_create"));
				...
				console.log("[ERROR] Cannot locate loupe field '" + field
						+ "' in current form.");
			}
		} else if (window.console && console.log) {
