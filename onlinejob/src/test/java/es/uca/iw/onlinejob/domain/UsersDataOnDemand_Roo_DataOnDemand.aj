...
import es.uca.iw.onlinejob.domain.RolesDataOnDemand;
...
privileged aspect UsersDataOnDemand_Roo_DataOnDemand {
    ...
    public void UsersDataOnDemand.setFecha_registro(Users obj, int index) {
        Date fecha_registro = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
